...
void loop() {
    ...
    if (client) {
        ...
        if (request.indexOf("/data") != -1) { // Anforderung der Sensordaten
            ...
            response += "body { font-family: 'IMPACT', Copperplate Gothic; background-color: #EBCD67; color: #333; text-align: center; display: flex; justify-content: center; align-items: center; height: 100vh; }";
            ...
            response += "h1 { font-size: 3em; color: #67B8EB;font-family: Comic Sans;  }"; // Überschrift auf 3em setzen
